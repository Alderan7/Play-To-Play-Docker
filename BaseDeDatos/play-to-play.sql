...
--
-- Servidor: localhost
-- Tiempo de generación: 31-05-2022 a las 18:27:11
...
(20, 5, 12, 'Esto es un comentario', '2022-05-28 14:08:15', '2022-05-28 14:08:15');
...
('rouyen@gmail.com', '$2y$10$3JnoM0AmPtBbKUngyulvxeCcQmjfNhBqKvV2SMlQw.2IwWxa7/X/O', '2022-05-29 15:51:29');
...
(7, 14, 15, 'Quee guay, voy aportar!! A ver si sale pronto el juego :)', '2022-05-29 16:36:41', '2022-05-29 16:36:41'),
(8, 14, 2, 'Tiene muy buena pinta!!', '2022-05-29 16:44:06', '2022-05-29 16:44:06');
...
(99, 1, 12, '2022-05-28 14:06:49', '2022-05-28 14:06:49'),
(101, 2, 13, '2022-05-28 14:10:35', '2022-05-28 14:10:35'),
(103, 6, 2, '2022-05-28 14:12:39', '2022-05-28 14:12:39'),
(104, 1, 14, '2022-05-28 16:16:57', '2022-05-28 16:16:57'),
(105, 1, 15, '2022-05-29 14:52:45', '2022-05-29 14:52:45'),
(107, 2, 16, '2022-05-29 16:29:04', '2022-05-29 16:29:04');
...
(1, 'Andrés', 'alderan133@gmail.com', NULL, '$2y$10$jRakIiIM.oqIYPtrz4UMA.pRkjHbmLTf6YjB8KARPC.vb8BJP50FG', 'qYUnFJ9XlPcFp9Fq2iuYe8DEFkhz3LCzHacCzUwOiI0pOmwsijuhldiCJ0uS', '2022-05-08 07:39:19', '2022-05-28 16:20:51', 'perfil-avatar-hombre-icono-redondo_629268037516f.jpg'),
(2, 'Rosa', 'inventada@inventada.com', NULL, '$2y$10$VWvHle4i/g9g64tXyGlXMu2vKGdwjDkR9g2kQcB7To1jHZ2h4aZq.', 'SxTw80UInYPb36Bgu025gupxsiQq0cPQEj0qTALWzXhPnqPRCZDNKb3BsDtO', '2022-05-08 14:19:55', '2022-05-24 15:55:23', NULL),
...
(12, 'Keroro', 'keroro@keroro.com', NULL, '$2y$10$aMU2DUsFVWdc1XrAvv.EXOg/I.NZTZe66MiL9vlwCckpeRGjqhzea', 'oDAzo2HMFMcoAuVZlLasfU6zimwpWu0WE8yTknjLgSW7T7gF3ZMQx51GZWNI', '2022-05-27 16:40:35', '2022-05-28 14:08:38', 'perfil-avatar-hombre-icono-redondo_62924906e7ad7.jpg'),
(13, 'Marina', 'marina@marina.com', NULL, '$2y$10$DSaDtFFqmz4Xfr0iHpGX6eoGLBV06uRnThg8IjcsMU3BIlJ4MJV8a', NULL, '2022-05-28 14:09:35', '2022-05-28 14:09:58', 'perfil-avatar-mujer-icono-redondo_6292495603b3d.jpg'),
(14, 'Usuario', 'usuario@usuario.com', NULL, '$2y$10$WpOKkzsW9KaV4V69AmLpeuCKbrdy3AcQKQ9gw.ztrg/1MYRVyr5wC', NULL, '2022-05-28 16:16:57', '2022-05-28 16:16:57', NULL),
(15, 'ALICIA', 'alicia@alicia.com', NULL, '$2y$10$hllpkJ7OMUhq4QbBeSGJGuLnKWDdvvShEPTQoWCMLNG7wNSozeQSO', NULL, '2022-05-29 14:52:45', '2022-05-29 16:37:08', 'perfil-avatar-mujer-icono-redondo_6293bd542c00c.jpg'),
(16, 'Rouyen', 'rouyen@gmail.com', NULL, '$2y$10$XngVCuJl5LxjTky7zEi6XuUQrkgqinBfuw1lPPWsjGQ93v7Rhib4u', 'WL0Mx2MxjhEUjuiZalAmZaOD6UpjKCOrKYMC6gyFL6fntmk6Jm2sF4Q2adiG', '2022-05-29 14:57:24', '2022-05-29 15:52:28', NULL);
...
ALTER TABLE `game_commentaries`
  ...
  ADD CONSTRAINT `game_commentaries_ibfk_3` FOREIGN KEY (`id_game`) REFERENCES `games` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `portfolio`
  ...
  ADD CONSTRAINT `portfolio_ibfk_2` FOREIGN KEY (`id_project`) REFERENCES `projects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `project_commentaries`
  ...
  ADD CONSTRAINT `project_commentaries_ibfk_3` FOREIGN KEY (`id_project`) REFERENCES `projects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
